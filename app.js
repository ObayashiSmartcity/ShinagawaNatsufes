...
const C = {
  ...
  grid: "rgba(255,255,255,.06)", tick: "#8b949e",
};
...
async function boot() {
  ...
  try {
    ...
    setText("#genAt", (json.generated_at || "").replace("T", " ").slice(0, 16));
  ...
  CHART_STORE.line = new Chart(ctx, {
    ...
    data: {
      ...
      datasets: [{
        ...
        pointRadius: 3, pointBackgroundColor: C.gray, pointBorderColor: "#0d0f12",
